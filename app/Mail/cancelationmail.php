...
class cancelationmail extends Mailable
{
    ...
    public function __construct($subject, $name, $enroll_number, $room_number, $allotment_date, $cancelation_date)
    {
